...
public abstract class GameCore {
    ...
    */
    ...
    public void init(){
        ...
        DisplayMode newDisplayMode =
            screen.findFirstCompatibleMode(POSSIBLE_MODES);  //use if get problems
    ...
    */
    ...
    public void playGame(long elapsedTime){

        checkInputWhenPaused();
            // update
            if(!pauseGame)
                update(elapsedTime);
    ...
    */
    ...
    public abstract void checkInputWhenPaused();
}
