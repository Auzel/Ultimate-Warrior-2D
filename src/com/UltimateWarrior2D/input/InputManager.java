package com.UltimateWarrior2D.input;
    ...
    MouseMotionListener, MouseWheelListener
{
    ...
    */
    ...
    public static InputManager getInstance(Component comp){
        if(inputManager!=null){
            return inputManager;
        }
        return new InputManager(comp);
    }

    private InputManager(Component comp) {
        this.comp = comp;
